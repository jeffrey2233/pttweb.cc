...
2. 請把你電腦edge的driver放在這邊。 ((重要!!!!
driver download link :"https://developer.microsoft.com/en-us/microsoft-edge/tools/webdriver?form=MA13LH"
...
2. Please put your computer edge driver here. ((Important !!!!
driver download link : “https://developer.microsoft.com/en-us/microsoft-edge/tools/webdriver?form=MA13LH”
...
11.As long as you don't modify the content of "processed_articles.txt", the program will not crawl articles that you 
