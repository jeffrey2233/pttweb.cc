...
class PTTImageCrawler:
    ...
    def load_processed_articles(self):
        """從檔案讀取已處理過的文章記錄"""
        try:
            file_path = r"C:\Users\Test\AppData\Local\Programs\Python\Python313\jeffrey練習小天地\processed_articles.txt"
    ...
    def start_driver(self):
        ...
        service = Service(r"C:\Users\Test\Desktop\jeffrey\driver\msedgedriver.exe")
    ...
    def crawl_ptt_page(self, search_term):
        ...
        parent_dir = r"C:\Users\Test\AppData\Local\Programs\Python\Python313\jeffrey練習小天地" + f"\\{search_term}"
